...
public class SlideMenu extends LinearLayout {
	 ...
	 */
	public SlideMenu(Activity activity, int menuResource, SlideMenuInterface.OnSlideMenuItemClickListener cb, int slideDuration) {
		super(activity);
	 ...
	 * @param slideDuration Slide in/out duration in milliseconds.
	 */
	public SlideMenu(Activity activity, SlideMenuInterface.OnSlideMenuItemClickListener cb, int slideDuration) {
	 ...
	 * @see android.view.animation.TranslateAnimation#setDuration(long)
	 * @param slideDuration
	 ...
	 * @see android.view.animation.TranslateAnimation#setInterpolator(android.view.animation.Interpolator)
	 * @param i
	 *         The {@link android.view.animation.Interpolator} object to set.
	 */
	...
	private void show(boolean animate) {
		 ...
		 */
		try {
			Method getSupportActionBar = activity.getClass().getMethod("getSupportActionBar", (Class[])null);
		...
		try {
			...
			if(Build.VERSION.SDK_INT < 18)
				...
				content = (ViewGroup) activity.findViewById(android.R.id.content).getParent(); //FIXME? what about the corner cases (fullscreen etc)
		}
		...
		ListView list = (ListView) activity.findViewById(R.id.menu_listview);
